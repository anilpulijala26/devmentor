    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="inline-flex items-center gap-1 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-[11px] font-bold text-slate-600 transition hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4F46E5]"
        >
    ...
    <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8">
      <div className="sticky top-16 z-40 -mx-4 mb-6 border-b border-slate-200/70 bg-slate-50/90 px-4 py-3 backdrop-blur-md sm:-mx-6 sm:px-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <Link
            href="/projects"
            className="inline-flex items-center gap-2 text-sm font-semibold text-slate-600 transition hover:text-[#4338CA]"
          >
              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`shrink-0 whitespace-nowrap rounded-full px-4 py-2 text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4F46E5] ${
                      isActive
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.techStack.map((tech) => (
                      <span
                        key={tech}
                        className="rounded-full border border-indigo-100 bg-indigo-50 px-3 py-1 text-xs font-semibold text-[#4F46E5]"
                      >
                        {tech}
                      </span>
                    ))}
              ...
              <div className="grid gap-5 lg:grid-cols-2">
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    <FolderTree className="h-4 w-4 text-[#4F46E5]" />
          ...
          <div className="space-y-5">
                  ...
                  return (
                    <div key={qa.question} className="overflow-hidden rounded-2xl border border-slate-200/80 bg-slate-50/60">
                      <button
                        ...
                        className="flex w-full items-center justify-between gap-3 px-4 py-4 text-left transition hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4F46E5]"
                      >
            ...
            <div className="rounded-[2rem] border border-slate-200/80 bg-white p-5 shadow-xs">
              <div className="flex items-start justify-between gap-4">
                ...
                <Link
                  href="/code-review"
                  className="inline-flex shrink-0 items-center gap-2 rounded-full bg-[#4F46E5] px-4 py-2 text-sm font-bold text-white transition hover:bg-[#4338CA]"
                >
                  Start Review
